...
| `--format` | `-f` | `markdown` | Link format: `wiki` ([[slug]]) or `markdown` ([Title](/blog/slug/)) |
| `--url-prefix` | — | `/blog/` | Base path for markdown links (can be overridden by `URL_PREFIX` env var) |
